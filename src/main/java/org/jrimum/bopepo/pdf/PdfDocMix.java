...
public class PdfDocMix {
    ...
    /**
     * Retorna um {@code Map} com os campos e seus respectivos textos
     * adicionados nessa instância.
     *
     ...
     * instância.
     *
     * @param txtMap Map com os campos(key) e textos(value)
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
     ...
     * @param value Valor em texto do campo
     *
     * @return Esta instância após a operação
     *
     * @since 0.2
     ...
     * instância.
     *
     * @param imgMap Map com os campos(key) e imagens(value)
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
     ...
     *
     * @param name Nome do campo
     * @param value Valor em {@link java.awt.Image} do campo
     *
     * @return Esta instância após a operação
     *
     * @since 0.2
     ...
     * </p>
     *
     * @param option Escolha por remoção
     *
     * @return Esta instância após a operação
     *
     * @since 0.2
     ...
     * {@linkplain #withTitle(String)}, {@linkplain #withSubject(String)}, etc.
     * serão substituídas pelo conteúdo do {@code docInfo} nessa operação.
     * </p>
     *
     * @param docInfo Informações sobre o documento
     *
     * @return Esta instância após a operação
     *
     ...
     *
     * @param destPath Caminho completo do arquivo o qual o documento será
     * gerado
     ...
     * Retorna o documento em forma de arquivo PDF.
     *
     * @param destURL URL do arquivo o qual o documento será gerado
     * @return Documento em forma de arquivo PDF
     *
     * @since 0.2
     *
     ...
     * Retorna o documento em forma de arquivo PDF.
     *
     * @param destFile Arquivo o qual o boleto será gerado
     * @return Documento em forma de arquivo PDF
     * @throws IllegalStateException Caso ocorral algum problema imprevisto
     *
     * @since 0.2
     *
     */
