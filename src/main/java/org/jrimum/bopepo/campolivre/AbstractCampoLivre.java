...
abstract class AbstractCampoLivre extends BlockOfFields implements CampoLivre {
     ...
     *
     * @param titulo com todos os dados para a geração do campo livre
     * @return instância de campo livre ou nulo.
     * @throws NotSupportedBancoException Caso o banco informado na conta
     * bancária não tenha nenhuma implementação de campo livre.
     * @throws NotSupportedCampoLivreException Caso exista implementações de
     * campo livre para o banco informa na conta bancária, mas nenhuma dessas
     * implementações foram adequadas para os dados do título.
     * @throws CampoLivreException Caso ocorra algum problema na geração do
     * campo livre.
     */
     ...
     * {@link AbstractCampoLivre#checkValues(Titulo)} e
     * {@link AbstractCampoLivre#addFields(Titulo)}, retornando em seguida esta
     * instância pronta para escrita.
     * </p>
     *
     * @param titulo
     *
    ...
    /**
     * <p>
     * Usado pelo método {@link AbstractCampoLivre#build(Titulo)} para verificar
     * a consistência do campo livre. Se algum inconsistência for verificada,
     * este método deverá lança-la.
     * </p>
     *
     * @param titulo
     *
    ...
    /**
     * <p>
     * Usado pelo método {@link AbstractCampoLivre#build(Titulo)}, adiciona os
     * campos do campo livre deixando-o pronto para escrita.
     * </p>
     *
     * @param titulo
     *
     ...
     *
     * @param titulo
     * @param length - Tamanho que deve ser
     *
     * @since 0.2
     */
