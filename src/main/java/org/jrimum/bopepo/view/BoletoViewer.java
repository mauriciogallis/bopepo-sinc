...
public class BoletoViewer {
     ...
     * </p>
     *
     * @param boleto Boleto preenchido
     *
     ...
     *
     * @param boleto Boleto preenchido
     * @param templatePath Template PDF o qual o boleto será gerado
     *
     * @throws IllegalArgumentException Caso o {@code boleto} ou
     * {@code template} seja nulo
     */
     ...
     *
     * @param boleto Boleto preenchido
     * @param templateFile Template PDF o qual o boleto será gerado
     *
     * @throws IllegalArgumentException Caso o {@code boleto} ou
     * {@code template} seja nulo
     */
     ...
     *
     * @param boleto Boleto preenchido
     * @param templateUrl Template PDF o qual o boleto será gerado
     *
     * @throws IllegalArgumentException Caso o {@code boleto} ou
     * {@code template} seja nulo
     */
     ...
     *
     * @param boleto Boleto preenchido
     * @param templateInput Template PDF o qual o boleto será gerado
     *
     * @throws IllegalArgumentException Caso o {@code boleto} ou
     * {@code template} seja nulo
     */
     ...
     *
     * @param boleto Boleto preenchido
     * @param template Template PDF o qual o boleto será gerado
     *
     * @throws IllegalArgumentException Caso o {@code boleto} ou
     * {@code template} seja nulo
     */
     ...
     *
     *
     * @param boletos Lista com os boletos a serem agrupados
     *
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param destPath Caminho para o arquivo que armazenará os boletos
     *
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param destFile Arquivo que armazenará os boletos
     *
     * @return Arquivo PDF gerado com os boletos da lista
     *
     * @since 0.2
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param templatePath Caminho para o arquivo com o template para geração
     * @return Arquivo PDF em array de bytes gerado com os boletos da lista
     *
     * @since 0.2
     */
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param templateUrl Arquivo com o template para geração
     * @return Arquivo PDF em array de bytes gerado com os boletos da lista
     *
     * @since 0.2
     */
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param templateFile Arquivo com o template para geração
     * @return Arquivo PDF em array de bytes gerado com os boletos da lista
     *
     * @since 0.2
     */
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param templateInput Arquivo com o template para geração
     * @return Arquivo PDF em array de bytes gerado com os boletos da lista
     *
     * @since 0.2
     */
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param template Arquivo com o template para geração
     * @return Arquivo PDF em array de bytes gerado com os boletos da lista
     *
     * @since 0.2
     */
     ...
     *
     *
     * @param templatesAndBoletos Coleção de templates e boletos a serem
     * agrupados
     *
     ...
     * arquivo PDF. Caso exista sequência no Map, a mesma dependerá da chamada
     * ao método {@link java.util.Map#entrySet() entrySet} do mesmo.
     * </p> * @param boletos Lista com os boletos a serem gerados
     *
     * @return Arquivo PDF em array de bytes gerado com os boletos fornecidos
     *
     * @since 0.2
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param destPath Diretório o qual os boletos serão criados
     *
     ...
     *
     * @param boletos Lista com os boletos a serem agrupados
     * @param destDir Diretório o qual os boletos serão criados
     *
     * @return Lista contendo os arquivos PDF gerados a partir da lista de
     * boletos
     *
     ...
     * @param boletos Lista com os boletos a serem agrupados
     * @param destPath Diretório o qual os boletos serão criados
     * @param prefixo Prefixo do nome do arquivo
     *
     * @return Lista contendo os arquivos PDF gerados a partir da lista de
     * boletos
     *
     ...
     * @param destPath Diretório o qual os boletos serão criados
     * @param prefixo Prefixo do nome do arquivo
     * @param sufixo Sufixo do nome do arquivo
     * @return Lista contendo os arquivos PDF gerados a partir da lista de
     * boletos
     *
     * @since 0.2
     ...
     * PDF como Acrobat Reader 6 ou superior. Entretanto, se o documento não for
     * comprimido [ {@code #setPdfFullCompression(false)} ], o boleto pdf gerado
     * no modelo de documento PDF 1.4 poderá ser lido por um visualizador tal
     * qual Acrobat Reader 5 ou superior.
     * </p>
     *
     ...
     *
     * @param titulo para ser exibido como título do documento PDF
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
    ...
    /**
     * Define se o título do documento PDF gerado será mostrado ou não (padrão
     * true).
     *
     * @param opcao para exibir título do documento PDF (true)
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
     ...
     *
     * @param assunto do documento PDF
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
     ...
     *
     * @param palavrasChave do documento PDF
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
    ...
    /**
     * Define se o os campos do documento PDF gerado devem ser removidos ou não
     * (padrão true).
     *
     * @param opcao para remover campos do documento PDF (true)
     * @return Esta instância após a operação
     *
     * @since 0.2
     */
     ...
     * </p>
     *
     * @param boleto Boleto a ser visualizado
     *
     * @since 0.2
     *
     * @return Esta instância após a operação
     ...
     * </p>
     *
     * @param destPath Caminho onde será criado o arquivo pdf
     ...
     * </p>
     *
     * @param destFile Caminho onde será criado o arquivo pdf
