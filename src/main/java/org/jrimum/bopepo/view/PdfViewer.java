...
/**
 * <p>
 * Classe utilizada para preencher o PDF do boleto com os dados do título e
 * boleto.
 * </p>
 *
...
class PdfViewer {
     ...
     *
     * @param destPath Caminho completo do arquivo o qual o boleto será gerado
     ...
     *
     * @param title para ser exibido como título do documento PDF
     *
     * @since 0.2
     */
     ...
     * true).
     *
     * @param option para exibir título do documento PDF (true)
     *
     * @since 0.2
     */
     ...
     *
     * @param subject do documento PDF
     *
     * @since 0.2
     */
     ...
     *
     * @param keywords do documento PDF
     *
     * @since 0.2
     */
     ...
     * (padrão true).
     *
     * @param option para remover campos do documento PDF (true)
     *
     * @since 0.2
     */
